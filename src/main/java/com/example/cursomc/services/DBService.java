...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException  {
		...
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));														//Salvar esses dois objetos no banco de dados
...
//-------------------------------------------------------------------------------------------------------------------//
		Cliente cli1 = new Cliente(null, "Maria Silva", "liao.dooug@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("912345678", "998989898"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "12345600", cli1, c1);
